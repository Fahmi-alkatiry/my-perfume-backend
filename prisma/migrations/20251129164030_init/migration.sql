...
CREATE TABLE `shift_kasir` (
    ...
    `modal_awal` DECIMAL(65, 30) NOT NULL,
    `uang_fisik_akhir` DECIMAL(65, 30) NULL,
    `uang_seharusnya` DECIMAL(65, 30) NULL,
    `selisih` DECIMAL(65, 30) NULL,
...
-- AddForeignKey
ALTER TABLE `shift_kasir` ADD CONSTRAINT `shift_kasir_id_pengguna_fkey` FOREIGN KEY (`id_pengguna`) REFERENCES `pengguna`(`id_pengguna`) ON DELETE RESTRICT ON UPDATE CASCADE;
