...
import { assignCustomerToTransaction, cancelTransaction, createTransaction } from '../controllers/transaction.controller.js';
...
router.put('/transactions/:id/assign-customer', protect, admin, assignCustomerToTransaction);
